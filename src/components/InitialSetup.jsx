...
const COPY = {
  vi: {
    welcome: ['Chào mừng đến với Dragonfyre Realms', 'Thiết lập nhanh vài tùy chọn để launcher phù hợp với bạn.'],
    ...
    done: ['Thiết lập hoàn tất!', 'Dragonfyre Realms đã sẵn sàng để bạn bắt đầu.'],
    continue: 'Tiếp tục', finish: 'Bắt đầu sử dụng', enabled: 'Bật', disabled: 'Tắt',
    default: 'Mặc định', gaming: 'Gaming',
  },
  en: {
    welcome: ['Welcome to Dragonfyre Realms', 'Set up a few preferences to make the launcher yours.'],
    ...
    done: ['Setup complete!', 'Dragonfyre Realms is ready when you are.'],
      ...
      <div className="relative w-full max-w-[720px] rounded-2xl border border-white/[0.09] bg-[#111216] overflow-hidden">
        ...
        <div className="px-7 pb-7 pt-5 sm:px-9 sm:pb-9">
          <div className="flex items-center justify-between mb-9">
            <div className="flex items-center gap-2.5"><img src={dragonfyreIcon} alt="" className="w-6 h-6 object-contain opacity-90" /><span className="text-xs font-bold tracking-[0.18em] text-white/65">DRAGONFYRE REALMS</span></div>

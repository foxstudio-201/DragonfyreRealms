...
function VXCLogo({ size = 56 }) {
  return <img src={dragonfyreIcon} alt="Dragonfyre Realms" className="rounded-xl" style={{ width: size, height: size }} />
}
    ...
    <div className="px-6 py-5">
      ...
      <div className="rounded-2xl border border-white/5 bg-gradient-to-br from-[#0d2b1a] via-[#0a1a0f] to-[#050d07] p-6 mb-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-5">
          ...
          <div>
            <h1 className="text-xl font-bold text-white tracking-tight">Dragonfyre Realms</h1>

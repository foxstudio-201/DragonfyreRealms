...
export default function DownloadErrorModal({ error, onClose }) {
  ...
  const title = isResource ? 'Lỗi tải tài nguyên' : 'Lỗi tải dữ liệu server'
  const subtitle = isResource ? 'Tải tài nguyên không thành công' : 'Đồng bộ dữ liệu không thành công'
  const fullText = [

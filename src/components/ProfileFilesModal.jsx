...
export default function ProfileFilesModal({ profile, onClose }) {
  ...
  const PRESETS = [
    ...
    { key: 'all', label: 'toàn bộ (config, mods, kubejs, .dragonfyre_base_version, .dragonfyre_sync_version)', targets: ['config', 'mods', 'kubejs', '.dragonfyre_base_version', '.dragonfyre_sync_version'] },
  ]
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[9999] p-4">
      <div className="border border-blue-500/15 rounded-2xl w-full max-w-3xl flex flex-col overflow-hidden"
        style={{ background: 'linear-gradient(165deg, #0c1526 0%, #05070d 55%, #03040a 100%)', maxHeight: '65vh', marginTop: '80px', marginBottom: '80px' }}

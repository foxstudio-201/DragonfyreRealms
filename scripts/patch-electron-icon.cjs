...
console.log('🔧  Patching electron.exe with Dragonfyre Realms icon...')

rcedit(electronExe, {
  icon: iconFile,
  'version-string': {
    ProductName:     'Dragonfyre Realms',
    FileDescription: 'Dragonfyre Realms',
    CompanyName:     'Dragonfyre Realms',
    LegalCopyright:  '© 2026 Dragonfyre Realms',
    InternalName:    'Dragonfyre Realms',
    OriginalFilename: 'Dragonfyre Realms.exe',
  },
